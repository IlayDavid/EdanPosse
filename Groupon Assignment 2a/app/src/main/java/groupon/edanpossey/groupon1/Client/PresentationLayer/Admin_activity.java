...
public class Admin_activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewOrders = (Button) findViewById(R.id.viewPendingCatalogItemsButton);
    ...
    public void viewPendingCatalogItems_ButtonClick(View view) {
        ObjectsHolder.setCurrentCatalogItemsList(ObjectsHolder.getBl().getPendingCatalogItems());
